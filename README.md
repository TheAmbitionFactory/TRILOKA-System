...
| Unit | Domain | Role |
|------|--------|------|
| **Garud** | Aerial (UAV) | Spectral imaging, reconnaissance, obstacle detection |
| **Varuna** | Surface (USV) | Mothership, AI command hub, sensor fusion |
| **Matsya** | Underwater (ROV) | Sonar scanning, HD inspection, crack detection |
...
- **Compute:** NVIDIA Jetson Nano Super
...
| Name | Institution |
|------|-------------|
| Aditya Singh Rajput | DIT University, Dehradun |
| Yash Raj | DIT University, Dehradun |
| Ayush Dixit | DIT University, Dehradun |
| Anurag Singh | Maulana Azad National Institute Of Technology, Bhopal |
| Sumit Jat | Maulana Azad National Institute Of Technology, Bhopal |
